    ...
    methods: {
      ...
      async saveEditItem(){
        ...
        try {
          ...
          let responseEditado = await axios.put(`http://localhost:3000/list/update/${this.editedItem._id}`, this.editedItem);
      ...
      async cobrar() {
        try {
          let responseDelete = await axios.delete(`http://localhost:3000/list/delete/${this.deleteId}`);
      ...
      async cargarTabla() {
        ...
        let responseDeudores = await axios.get(`http://localhost:3000/list/all/${this.user.usuario._id}`);
